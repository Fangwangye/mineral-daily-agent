...
from .models import PriceQuote, PriceTrend
...
@mcp.tool()
async def get_price(commodity: str, date: str | None = None) -> PriceQuote:
    """查询某商品单日价格。
    ...
    """
    return PriceQuote(**await providers.price_on(commodity, date))


@mcp.tool()
async def get_trend(commodity: str, days: int = 30) -> PriceTrend:
    ...
    """
    return PriceTrend(**await providers.trend(commodity, days))
